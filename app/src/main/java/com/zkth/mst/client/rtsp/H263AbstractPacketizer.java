...
/**
 * Created by qingli on 2018/4/2
 */

public abstract class H263AbstractPacketizer {
    ...
    public H263AbstractPacketizer() throws IOException {
     ...
     * @param rtpPort Destination port_icon that will be used for RTP
     * @param rtcpPort Destination port_icon that will be used for RTCP
     */

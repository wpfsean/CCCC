...
import com.zkth.mst.client.utils.SPUtils;
import com.zkth.mst.client.utils.VersionUtils;
...
public class ApkUpdateUtils {
    ...
    private static boolean compare(PackageInfo info) {
        ...
        if (info.packageName.equals(VersionUtils.getPackageName())) {
            if (info.versionCode > VersionUtils.getVersionCode()) {
                return true;
            }
        }
